...
Graphics._updateRealScale = function () {
    if (this._stretchEnabled) {
        ...
        if (h >= 1 && h - 0.01 <= 1) h = 1;
        if (v >= 1 && v - 0.01 <= 1) v = 1;
        // Store both horizontal and vertical scales separately for fullscreen
        this._realScaleX = h;
        this._realScaleY = v;
        this._realScale = Math.min(h, v); // Keep for compatibility
    } else {
        this._realScaleX = this._scale;
        this._realScaleY = this._scale;
...
Graphics._centerElement = function (element) {
    // Use separate horizontal and vertical scales to fill the screen
    var scaleX = this._realScaleX || this._realScale;
    var scaleY = this._realScaleY || this._realScale;
